...
using MovieRecommendationApi.BSM.BSC.Embedding.Repository.Implementations;
using Newtonsoft.Json;
using Newtonsoft.Json.Linq;

namespace MovieRecommendationApi.BSM.BSC.Embedding.Service.Implementations
{
    public class RecommendationService : IDisposable
    {
        private readonly RecommendationRepository _embeddingRepository;
        private readonly InferenceSession _session;
        private readonly Dictionary<string, int> _vocabulary;
        private readonly int _maxLength;

        public RecommendationService(RecommendationRepository embeddingRepository, string modelPath, string tokenizerPath, int maxLength = 128)
        {
